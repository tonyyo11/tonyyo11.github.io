---
title: "Reflections on My MacAdmin Journey"
date: 2025-04-16 3:00:00 -0400
description: "A reflection on my life and career journey as I perform a Career Audit."
tags: [macOS, Career, Professional Development, Personal Development, Leadership, Career Audit, MacAdmins]
categories: [Off the Clock]
pin: false
---

![Reflections on My MacAdmin Journey Banner.png](/assets/img/postimages/Reflections_on_My_MacAdmin_Journey_Banner.png){: lqip="/assets/img/postimages/Reflections_on_My_MacAdmin_Journey_Banner.png" }
...
If you’re interested in performing a career audit of your own, I’ve made my personal template available on [GitHub](https://github.com/tonyyo11/MacAdministration/blob/main/Docs/Self_Career_Audit_Template.md). It’s the same one I used to write this post—adapted for tech professionals who want to reflect with depth and clarity.
...
![IMG_5095.jpeg](/assets/img/postimages/IMG_5095.jpeg){: .left }
...
Due to Compucom being a registered Partner with Jamf, I had access to additional resources, documentation, learning, and tools to enhance my knowledge and best practices to deliver exceptional service to the client. This allowed me to obtain partner specific certifications, like the [Jamf Management Consultant, Engineer, and Integrator](https://www.credly.com/users/tonyyo11) certifications. These Partner-specific certifications have helped me stand out and above some of the competition when I had begun my job search again. But beyond that, I helped to mentor the help desk in tier two level troubleshooting, which selfishly helped myself as the end result was less tickets being escalated to me.
...
> “Client Platform Engineering teams deploy, manage, secure and decommission endpoints at an enterprise scale. The main goal of the team is to provide an excellent user experience to every employee and set secure defaults from day one…”
— Kane Narraway,
[What is Client Platform Engineering](https://kanenarraway.com/posts/client-platform-engineering/)
> 
...
> Companies move to Apple infrastructure -
> They roll out Jamf, Kandji, Intune, ABM -
> And then they try to hire the way they always have. That’s where it goes wrong. Because hiring for Apple IT roles requires a completely different lens.
> – Chris Lo [[LinkedIn](https://www.linkedin.com/posts/activity-7317456683792822272-OKC6)]
> 
...
You can view or reuse my roadmap template on [GitHub](https://github.com/tonyyo11/MacAdministration/blob/main/Docs/Career_Roadmap_Template.md).
