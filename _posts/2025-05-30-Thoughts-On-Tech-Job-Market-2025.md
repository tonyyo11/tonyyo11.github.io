---
title: "Thoughts on the Tech Job Market in 2025"
date: 2025-05-30 16:45:00 -0400
...
The tech industry has always been fast-moving, but the last few years have taken things to a new level. According to the [2025 Dice Tech Salary Report](https://www.dice.com/technologists/ebooks/tech-salary-report/salary-trends.html), average tech salaries have risen slightly to $112,521—a 1.2% increase. But that number masks some unsettling trends. Entry-level roles are actually seeing salary declines, and nearly half of tech professionals are actively job-hunting. 

On top of this, we’ve watched wave after wave of layoffs, especially across IT departments, as companies downsize or restructure. It’s not just about pay—people are questioning stability. And for those trying to break into tech, underemployment has become a looming threat with [more than half of recent 4-year college graduates](https://www.insidehighered.com/news/students/academics/2024/02/22/more-half-recent-four-year-college-grads-underemployed#:~:text=More%20than%20half%20of%20recent,year%20degree) reporting themselves as underemployed. Even computer science grads are struggling to land entry-level roles that match their qualifications.

## **Entry-Level Jobs Are Disappearing Before Our Eyes**

A recent [CBS News article](https://www.cbsnews.com/news/college-graduate-unemployed-technology-artificial-intelligence/) captured this well: more college graduates are finding themselves unemployed or forced into unrelated jobs. Many are considering career changes just to make ends meet.
...
[Duolingo’s recent pivot to an “AI-first”](https://www.groktop.us/duolingos-ai-first-disaster-a-cautionary-tale-of-what-happens-when-you-replace-rather-than-partner/) strategy offers a cautionary tale. By trying to replace human translators and content creators with AI, they laid off 10% of their contractor workforce. The backlash was swift—internal unrest and public outcry led to lost credibility.
...
- [CSforALL](https://www.csforall.org/) – National initiative to expand access to computer science education.
- [Apprenticeship.gov](https://www.apprenticeship.gov/) – Explore paid training opportunities across industries.
- [Code.org](https://www.code.org/) – Free resources for kids and schools to learn coding.
- [TechGirlz](https://www.techgirlz.org/) – Free workshops for middle school girls interested in tech.
...
> I think if we ever get to that level (and I am skeptical, but think it's non-zero) everyone who is trying to create anything without fundamentals will be replaced by those with the fundamentals and the AI to maximize output. – tlark [MacAdmins Slack]
---

### **More Reading**

[Strada and The Burning Glass Institute - Talent Disrupted: College Graduates, Underemployment, and the Way Forward (PDF Download)](https://static1.squarespace.com/static/6197797102be715f55c0e0a1/t/65fb306bc81e0c239fb4f6a9/1710960749260/Talent+Disrupted+03052024.pdf).

---

### **Underrated macOS Feature:**

**Spotlight Calculator and Unit Converter.**

No need to open a separate app or Google—just press Command + Space and type math directly into Spotlight. You can solve equations like:

```
234 * 19.75
```

Or convert units on the fly:
...
It’s fast, offline, and surprisingly accurate—perfect for quick conversions during meal prepping, budgeting, or even home projects.
